...
#define  EPID_POSITION_HANDLER		 7
...
typedef struct ReportData{
	...
	double cbctPlaneVerticalty;
	double epidPlaneVerticalty;
	double gantryVar;
	double gantryMean;
...
private slots:
	...
	void cbctPlanePosition(Plane_T& plane);
	void epidPlanePosition(Plane_T& plane);
...
private:
	...
	EpidHandler*   m_EpidPositionHandler;
