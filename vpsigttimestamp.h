#ifndef TIMESTAMP_H_HEADER_INCLUDED_
#define TIMESTAMP_H_HEADER_INCLUDED_
...
#include "vpsrealtimeclock.h"
  ...
  * \ingroup IGT
  */
  class IGTTimeStamp : public itk::Object
  {
  public:

    vpsClassMacro(IGTTimeStamp, itk::Object);
    ...
    * <bla>RealTimeClock::Pointer RealTimeClock = <bla>RealTimeClock::New();
    * TimeStamp::GetInstance()->SetRealTimeClock(RealTimeClock);
    *
    ...
    * by default.
    */
    void SetRealTimeClock(RealTimeClock::Pointer Clock);
  ...
  protected:
    ...
    static IGTTimeStamp::Pointer s_Instance;
