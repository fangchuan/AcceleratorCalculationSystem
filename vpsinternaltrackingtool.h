#ifndef INTERNALTRACKINGTOOL_H_HEADER_INCLUDED_
#define INTERNALTRACKINGTOOL_H_HEADER_INCLUDED_
...
public:
	...
	virtual bool Enable();                                      ///< enable the tool, so that it will be tracked. Returns true if enabling was successful
	virtual bool Disable();                                     ///< disables the tool, so that it will not be tracked anymore. Returns true if disabling was successful
